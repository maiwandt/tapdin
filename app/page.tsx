  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <header className="flex items-center px-8 py-6 border-b border-white/10">
        <span className="text-2xl font-bold tracking-tight text-gold">TapdIn</span>
      </header>

      {/* Hero */}
      <section className="flex flex-col items-center justify-center text-center flex-1 px-6 py-20">
        <p className="text-sm uppercase tracking-widest text-gold-dim mb-6">
        ...
        <h1 className="text-5xl md:text-7xl font-bold leading-tight max-w-4xl mb-6">
          ...
          Real feedback.
          <br />
          <span className="text-gold">Real connections.</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
          <Link
            href="/artists"
            className="flex-1 flex flex-col items-center gap-1 bg-gold text-[#0a0a0a] font-bold text-lg py-5 px-6 rounded-xl hover:bg-gold-light transition-colors"
          >
          ...
          <Link
            href="/professionals"
            className="flex-1 flex flex-col items-center gap-1 border border-gold/30 font-bold text-lg py-5 px-6 rounded-xl hover:bg-gold/5 transition-colors"
          >
